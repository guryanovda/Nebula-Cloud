...
if((realpath($_GET['section'])=='C:\xampp\htdocs\TrollOS12\filesave') or ($_GET['section']=='C:/../') )
{
header ("Location: index.php");
}
if ($_GET['section']=='cloud'):
		$_GET['section']=realpath('../../cloud/');
		endif;
?>
<!DOCTYPE html >
<html >
...
if($dir=opendir($section)):
		while (false!==($file=readdir($dir))) {
			...
			$dirr=1;
				...
				$f=$f.shortname($s);
				$f=$f.'</td><td width="6%">folder</td><td width="4%" ></td><td align="right" width="15%"><a href="files.php?section='.$section.'&funct=unlink&obj='.$s.'"><img src="../../style/cancel.png" width="16" height="16"></td></tr>';
				print $f;
				$f='';}
		...
		while (false!==($file=readdir($dir))) {
			...
			$dirr=1;
				...
				$f=$f.shortname($s);
				$f=$f.'</td><td width="6%">'.getfiletype($s).'</td><td width="4%" >'.getfilesize($section.'/'.$s).'</td><td align="right" width="15%"><a href="files.php?section='.$section.'&funct=unlink&obj='.$s.'"><img src="../../style/cancel.png" width="16" height="16"></td></tr>';
				print $f;
				$f='';}
...
if($dirr==0):
print '<tr><td><img src="../../style/9.png" width="128" height="128"></td><td align="left"><h2>Этот каталог пуст</h2></td><td></td></tr>';
endif;
?>
</table>
<table width="100%" border="0">
